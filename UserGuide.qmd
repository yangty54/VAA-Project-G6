...
### No. of Shipments per Month, 2028-2034

This tab shows the number of shipments per month from 2028 to 2034.

![](images/275731688311821_.pic.jpg)

1.  Start by selecting month from the drop-down list. Users can choose as many months as they want.

2.  Then the bar chart will demonstrate the number of shipments per month from 2028 to 2034. When the users hover their mouse over the graph it will display the number of shipments for specific year and month. Comparison can be showed when multiple months are selected.
...
![](images/275941688312005_.pic.jpg)

![](images/275951688312012_.pic.jpg)

1.  Start by selecting time range, degree centrality percentile and weight percentile from the slider.
